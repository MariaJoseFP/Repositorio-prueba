                    ...
                    <div class="panel-body">
                        <form action="enviar.php" method="post" role="form" enctype="multipart/form-data" id="frmSubirImagen">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="imagen" id="imagen" placeholder="Input...">
                            </div>

                            <button type="submit" class="btn btn-primary id="ci">Cargar imagen</button>
                        </form>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <form action="enviar.php" method="post" role="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="nombre" id=nombre" placeholder="Nombre..." onchange="loadDoc()">
                    ...
                    <input type="hidden" id="nfoto"name="foto" value="">
                    

                    <input type="submit" class="btn btn-primary" name="guardar" value="Guardar" id="guardar"></input>
                </form>
            </div>
        </div>
    </div>
